...
function TradePageInner() {
  ...
  var component = (function () {
    if (handleDeprecated) {
      return react_1['default'].createElement(DeprecatedMarketsPage, {
        switchToLiveMarkets: function switchToLiveMarkets() {
  ...
  var onAddCustomMarket = function onAddCustomMarket(customMarket) {
  ...
  var onDeleteCustomMarket = function onDeleteCustomMarket(address) {
...
function MarketSelector(_a) {
  ...
  var onSetMarketAddress = function onSetMarketAddress(marketAddress) {
    setHandleDeprecated(false);
    setMarketAddress(marketAddress);
  };

  var extractBase = function extractBase(a) {
    return a.split('/')[0];
  };

  var extractQuote = function extractQuote(a) {
    return a.split('/')[1];
  };
...
var DeprecatedMarketsPage = function DeprecatedMarketsPage(_a) {
...
var RenderNormal = function RenderNormal(_a) {
...
var RenderSmall = function RenderSmall(_a) {
  var onChangeOrderRef = _a.onChangeOrderRef,
    onPrice = _a.onPrice,
    onSize = _a.onSize;
  return react_1['default'].createElement(
...
var RenderSmaller = function RenderSmaller(_a) {
  var onChangeOrderRef = _a.onChangeOrderRef,
    onPrice = _a.onPrice,
    onSize = _a.onSize;
  return react_1['default'].createElement(
