  ...
  return (
    ...
    >
      <div style={{ flex: 1 }}>
        ...
        <div className="gradient-input-back">
          <Input
          ...
          />
          <span className='input-placeholder'>Price</span>
        </div>
        ...
        <div className="gradient-input-back">
          ...
          />
          <span className='input-placeholder'>Total</span>
        </div>
        {/* </Input.Group> */}
        <Slider
          value={sizeFraction}
        ...
        />
        <div style={{ paddingTop: 18, display: 'flex', alignItems: 'center' }}>
          <div>
            {'POST Only '}
            <Switch
              checked={postOnly}
      ...
      {
        side === 'sell' && connected ? <SellButton
          className="gradient-btn-back"
          disabled={!price || !baseSize}
          onClick={onSubmit}
          block
      ...
      {
        !connected ? <Button className="gradient-btn-back" size="large" style={{marginTop: '20px'}} onClick={select}>Connect to a Wallet</Button> : null
      }
    </FloatingElement>
  );
}
