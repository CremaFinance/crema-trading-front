...
function TradeForm(_a) {
  ...
  var onSetBaseSize = function (baseSize) {
  ...
  var onSetQuoteSize = function (quoteSize) {
    setQuoteSize(quoteSize);
    if (!quoteSize) {
  ...
  var updateSizeFraction = function () {
    var rawMaxSize =
  ...
  var postOnChange = function (checked) {
    if (checked) {
      setIoc(false);
    }
    setPostOnly(checked);
  };
  var iocOnChange = function (checked) {
    if (checked) {
      setPostOnly(false);
    }
    setIoc(checked);
  ...
  return react_1['default'].createElement(
    ...
    { style: __assign({ display: 'flex', flexDirection: 'column' }, style) },
    react_1['default'].createElement(
      ...
      react_1['default'].createElement(
        'div',
        { style: { paddingTop: 18, display: 'flex', alignItems: 'center' } },
        react_1['default'].createElement(
          'div',
          null,
          'POST Only ',
