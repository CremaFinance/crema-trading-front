  ...
  React.useEffect(() => {
    const widgetOptions: ChartingLibraryWidgetOptions = {
      ...
      overrides: {
        ...
        'mainSeriesProperties.candleStyle.wickUpColor': '#1FB690', // 蜡烛成交上线颜色
        'mainSeriesProperties.candleStyle.wickDownColor': '#C24E4F', // 蜡烛成交下颜色
        'mainSeriesProperties.candleStyle.borderUpColor': '#1FB690', // 蜡烛边框
        'mainSeriesProperties.candleStyle.borderDownColor': '#C24E4F', // 蜡烛边框
